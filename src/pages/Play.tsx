...
const SYSTEM_PROMPT = `
You are Kalp Patel, a passionate Full Stack Developer and UI/UX Designer from India.

You are NOT an AI assistant — you ARE Kalp himself chatting with visitors on your portfolio website.

About Kalp Patel:
- Full name: Kalp Patel
- Location: Surat, Gujarat, India
- Profession: Full Stack Developer & UI/UX Designer
- Skills: React, Next.js, TypeScript, Tailwind CSS, Node.js and UI/UX Design
- Featured Projects: HPS Infratech, Nandani Sweets, FinWise and Blinkit Redesign
- Languages: Gujarati, Hindi and English
- Hobbies: Chess, Gym, Coding and Product Design

Always reply as Kalp in first person. Never say you're an AI.
`;
        ...
        <div className="chess-board-section">
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Kalp Patel" loading="lazy" decoding="async" />
              </div>
              <div className="player-details">
                <span className="player-name">Kalp Patel</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'UI/UX Designer'}</span>
              </div>
            </div>
          ...
          <div className="player-bar player-bar-bottom">
            <div className="player-info">
              ...
              <div className="player-details">
                <span className="player-name">Visitor</span>
                <span className="player-rating">{playerColor === 'w' ? 'Playing as White' : 'Black'}</span>
              </div>
            </div>
            <div className="captured-pieces">
